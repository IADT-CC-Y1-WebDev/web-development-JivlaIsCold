...
<body>
    ...
    <div class="output">
        ...
        $profile = new StudentAccount("Ben O Connor","00254975");
        $profile->Name = "Ben O Connor";
        $profile->Number = "00254975";


        print_r("Name: " .$profile->Name . "<br>");
        print_r("Number: ".$profile->Number . "<br>");
    ...
    <div class="output">
        ...
        $account = new StudentAccount("Ben O Connor", "00254975");
        $account2 = new StudentAccount("Ryan Whelan", "00254850");

        print_r("Name: " . $account->Name . "<br>");
        print_r("Number: " .$account->Number . "<br>");
        print_r("Name: " . $account2->Name . "<br>");
        print_r("Number: " . $account2->Number . "<br>");
        ?>
    </div>
    ...
    <div class="output">
        ...
        $STUDENT_ACCOUNT = new StudentAccount("Ben O Connor", "00254975");
        
        $GetName = $STUDENT_ACCOUNT->GetName();
        $GetNumber= $STUDENT_ACCOUNT->getNumber();

        echo "Student $GetName has number $GetNumber";
        ?>
    </div>
