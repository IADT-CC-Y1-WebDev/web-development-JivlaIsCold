...
<body>
    ...
    <div class="output">
        ...
        $Account = new Undergrad("Ben O Connor", "N00254975", "Creative Computing", 2025);
    ...
    <div class="output">
        ...
        $Account1 = new Undergrad("Ben O Connor", "N00254975", "Creative Computing", 2025);
    ...
    <div class="output">
        ...
        $acc1 = new Undergrad("Ben O Connor", "N00254975", "Creative Computing", "2025");
